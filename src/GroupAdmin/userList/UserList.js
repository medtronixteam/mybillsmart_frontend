...
const UserList = () => {
  ...
  const fetchUserDetails = async (id) => {
    try {
      const response = await fetch(
        `http://34.142.252.64:8080/api/group/user/detail/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleDisableClick = async (id) => {
    try {
      const response = await fetch(
        `http://34.142.252.64:8080/api/group/user/disable/${id}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleEnableClick = async (id) => {
    try {
      const response = await fetch(
        `http://34.142.252.64:8080/api/group/user/enable/${id}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDeleteClick = async (id) => {
    try {
      const response = await fetch(
        `http://34.142.252.64:8080/api/group/user/delete/${id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
