...
import "./SupervisorManageGoal.css";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${config.BASE_URL}/api/supervisor/goals`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
...
export default SupervisorManageGoal;
